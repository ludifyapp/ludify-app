      ...
      <div className="max-w-lg mx-auto px-4 pt-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
      </div>
        ...
        {isLoading ? (
          ...
          search.trim() ? (
            <div className="text-center py-16 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-200 font-medium">No results for &ldquo;{search.trim()}&rdquo;</p>
              <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Try a different game or host name</p>
            </div>
          ) : (
            <EmptyState tab={tab} />
          )
