    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 pt-5 pb-3 flex-shrink-0">
          ...
          <h2 className="font-semibold text-gray-900 text-base">Share with Friends</h2>
          <div className="w-8" />
        </div>
              ...
              {filtered.map((friend) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="text-xs text-gray-700 text-center leading-tight w-full truncate px-1">
