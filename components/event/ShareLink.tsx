  ...
  return (
    <div className="flex flex-row gap-2 sm:gap-3">
      ...
      <div className="relative flex-1">
        {copied && (
          <span className="sm:hidden absolute -top-8 left-1/2 -translate-x-1/2 bg-on-surface text-surface text-[11px] font-semibold px-2.5 py-1 rounded-full whitespace-nowrap pointer-events-none animate-fade-in-out">
            {t('share.copied', 'Copied!')}
          </span>
        )}
        <Button variant="secondary" onClick={handleCopy} className="w-full justify-center py-2.5 sm:py-3 h-auto px-2 sm:px-4">
          <svg className="w-5 h-5 sm:mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
